...
const translations = {
  es: {
    ...
    'cover.meta': '<span class="cover__date">16 DE ENERO, 2027</span><span class="cover__dot"> &nbsp;&middot;&nbsp; </span><span class="cover__place">PUERTO VALLARTA, JALISCO</span>',
    ...
    'details.mapLink': 'Ver en Google Maps →',
    'details.mapDisclaimer': 'Verifica que el destino esté en Mismaloya. Si vienes desde el aeropuerto, la ruta atraviesa Puerto Vallarta.',
    ...
    'hotels.instruction': 'Toca cualquier foto para ver el hotel',
    'hotels.intro': 'Están ordenados del más cercano al más lejano de la celebración.',
    ...
    'dresscode.menLabel': 'Hombres &middot; Traje formal',
    'dresscode.menDesc': 'Traje regular o de lino, acompañado de camisa y zapatos acordes a una celebración formal en la playa.',
    ...
    'faq.a6': '<p>Agradeceremos confirmar tu asistencia a más tardar el 1 de diciembre. Después de esta fecha, asumiremos que no podrás acompañarnos y no podremos garantizar tu lugar.</p>',
    'faq.q7': '¿Qué tipo de comida se servirá?',
    'faq.a7': '<p>Nuestro menú será de inspiración mediterránea e incluirá carne y pollo, además de ensaladas, acompañamientos y algunas opciones sin carne.</p>',
    'faq.q8': '¿A qué hora termina el evento?',
    'faq.a8': '<p>La celebración durará aproximadamente 10 horas y la música terminará a las 11:00 p.m. para respetar el entorno residencial.</p>',
    'faq.q9': '¿Hay estacionamiento en la recepción?',
    'faq.a9': '<p>No contamos con estacionamiento en el lugar, por lo que recomendamos llegar en Uber o taxi. Al bajar la montaña hay sitios de taxi, lo que facilitará el transporte de regreso.</p>',
  ...
  en: {
    ...
    'cover.meta': '<span class="cover__date">JANUARY 16TH, 2027</span><span class="cover__dot"> &nbsp;&middot;&nbsp; </span><span class="cover__place">PUERTO VALLARTA, JALISCO</span>',
    ...
    'details.mapLink': 'See on Google Maps →',
    'details.mapDisclaimer': 'Please double-check the pin lands in Mismaloya. If you\'re coming from the airport, the route passes through Puerto Vallarta.',
    ...
    'hotels.instruction': 'Tap any photo to see that hotel',
    'hotels.intro': 'They\'re ordered closest to farthest from the party.',
    ...
    'dresscode.menLabel': 'Men &middot; Formal suit',
    'dresscode.menDesc': 'A regular or linen suit, with a shirt and shoes fitting a formal beach celebration.',
    ...
    'faq.a6': '<p>We\'d appreciate you confirming your attendance by December 1st at the latest. After this date, we\'ll assume you won\'t be able to join us and we won\'t be able to guarantee your spot.</p>',
    'faq.q7': 'What kind of food will be served?',
    'faq.a7': '<p>Our menu will have a Mediterranean-inspired feel, including beef and chicken, along with salads, side dishes, and a few meat-free options.</p>',
    'faq.q8': 'What time does the event end?',
    'faq.a8': '<p>The celebration will last approximately 10 hours, and the music will end at 11:00 pm out of respect for the residential neighborhood.</p>',
    'faq.q9': 'Is there parking at the reception?',
    'faq.a9': '<p>There\'s no parking available on site, so we recommend arriving by Uber or taxi. There are taxi stands at the bottom of the hill, which will make getting back easier.</p>',
